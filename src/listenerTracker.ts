...
export class ListenerTracker {
    ...
    private _listenerMap: {[eventName: string]: Array<(...args: any[]) => void>};
     ...
     */
    public on(eventName: string, listenerCallback: (...args: any[]) => void): this {
     ...
     * @return This ListenerTracker instance so that calls can be chained.
     */
    public once(eventName: string, listenerCallback: (...args: any[]) => void): this {
     ...
     * @param listenerCallback - The callback function/listener
     */
    private addListener(eventName: string, listenerCallback: (...args: any[]) => void): void {
